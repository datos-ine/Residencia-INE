...
## Operadores de comparación {.title-top .nostretch}

<br>

![](img/04/operadores.PNG){fig-align="center" width="50%"}


## Operadores lógicos (booleanos) {.title-top .nostretch}

<br>


![](img/04/booleanos2.PNG){fig-align="center" width="70%"}
...
![](img/04/booleanos.PNG){fig-align="center" width="60%"}
...
## Documentación{.invert .nostretch}

<br>

![](img/03/r4ds2.png){fig-align="center" width="15%"}
