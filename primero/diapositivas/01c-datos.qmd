...
## Formatos de archivos {.title-top}
...
## Almacenamiento y seguridad {.title-top}
...
## Control de versiones {.title-top}
...
## Depuración {transition="slide" .title-top}
