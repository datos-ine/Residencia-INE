...
Muchas de las tareas que hicimos hasta ahora, ya sea transformando u obteniendo resultados resúmenes de variables, las aplicamos variable a variable, es decir repitiendo las operaciones para cada una de las columnas de una tabla.
